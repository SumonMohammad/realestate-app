...
const PropertyDetails = ({ propertyDetails: { price, photos, agency, rentFrequency, area, purpose, rooms, baths, description, isVerified, type, title, furnishingStatus, amenities } }) => (
    <Box maxWidth="1000px" p="4" margin="auto">
        {photos && <ImageContainer data={photos} />}
        <Box w='full' p='6'>
